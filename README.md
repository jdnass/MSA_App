...
An installable iPhone web app for studying Modern Standard Arabic. It includes complete Chapter 1 and Chapter 4 vocabulary and sentences, automatic Arabic text-to-speech, swipeable study cards, lesson position sliders, replay and skip controls, global study-display options, persistent vocabulary position and 1–5 difficulty ratings, chronological study, and difficulty-weighted shuffle. Swipe right for the next card or left for the previous card.
