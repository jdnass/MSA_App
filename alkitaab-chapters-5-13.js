...
const AK_G8=[
{id:'ak-c8-g1',type:'intro',title:'Grammar Overview',body:`<p>In this lesson, we will discuss the past and future tense.</p>`},
{id:'ak-c8-g2',type:'note',title:'The Past Tense',body:`<p>For a regular verb such as “to write,” the past tense starts from the “he” form [كَتَبَ], which follows the pattern [فَعَلَ]. Notice the fatḥa after each of the three root letters. We add a suffix to show who did the action; there is no person prefix.</p><p>The “he” form is identical to that starting form. With “she,” the final fatḥa stays and [تْ] is added. Other forms replace the final fatḥa with another vowel or a sukūn before the suffix.</p><p class='conjugation-intro'>The pronouns, changed final vowel, and added suffixes are red. The root letters remain black.</p><table class='conjugation-table' aria-label='Past-tense conjugation of to write'><tbody>
<tr><td><div class='conjugation-ar'><span class='conjugation-red'>أَنَا</span> كَتَب<span class='conjugation-red'>ْتُ</span></div><span class='conjugation-en'>I wrote</span></td><td><div class='conjugation-ar'><span class='conjugation-red'>نَحْنُ</span> كَتَب<span class='conjugation-red'>ْنَا</span></div><span class='conjugation-en'>We wrote</span></td></tr>
<tr><td><div class='conjugation-ar'><span class='conjugation-red'>أَنْتَ</span> كَتَب<span class='conjugation-red'>ْتَ</span></div><span class='conjugation-en'>You (male) wrote</span></td><td><div class='conjugation-ar'><span class='conjugation-red'>أَنْتُمْ</span> كَتَب<span class='conjugation-red'>ْتُمْ</span></div><span class='conjugation-en'>You all (male/mixed) wrote</span></td></tr>
<tr><td><div class='conjugation-ar'><span class='conjugation-red'>أَنْتِ</span> كَتَب<span class='conjugation-red'>ْتِ</span></div><span class='conjugation-en'>You (female) wrote</span></td><td><div class='conjugation-ar'><span class='conjugation-red'>أَنْتُنَّ</span> كَتَب<span class='conjugation-red'>ْتُنَّ</span></div><span class='conjugation-en'>You all (female) wrote</span></td></tr>
<tr><td><div class='conjugation-ar'><span class='conjugation-red'>هُوَ</span> كَتَبَ</div><span class='conjugation-en'>He wrote</span></td><td><div class='conjugation-ar'><span class='conjugation-red'>هُمْ</span> كَتَب<span class='conjugation-red'>ُوا</span></div><span class='conjugation-en'>They (male/mixed) wrote</span></td></tr>
<tr><td><div class='conjugation-ar'><span class='conjugation-red'>هِيَ</span> كَتَبَ<span class='conjugation-red'>تْ</span></div><span class='conjugation-en'>She wrote</span></td><td><div class='conjugation-ar'><span class='conjugation-red'>هُنَّ</span> كَتَب<span class='conjugation-red'>ْنَ</span></div><span class='conjugation-en'>They (female) wrote</span></td></tr>
</tbody></table>`},
{id:'ak-c8-g3',type:'note',title:'The Future Tense',body:`<p>To form the future tense, either attach [سَـ] to the beginning of a present-tense verb or put the separate word [سَوْفَ] before that same present-tense verb.</p><div class='grammar-example'><strong>I will travel to Lebanon tomorrow.</strong><br>[سَأُسَافِرُ إِلَى لُبْنَانَ غَدًا.]<br>[سَوْفَ أُسَافِرُ إِلَى لُبْنَانَ غَدًا.]</div><div class='grammar-example'><strong>You (male) will read lesson 3 later.</strong><br>[سَتَقْرَأُ الدَّرْسَ الثَّالِثَ لَاحِقًا.]<br>[سَوْفَ تَقْرَأُ الدَّرْسَ الثَّالِثَ لَاحِقًا.]</div><div class='grammar-example'><strong>He will go to the restaurant tonight.</strong><br>[سَيَذْهَبُ إِلَى الْمَطْعَمِ اللَّيْلَةَ.]<br>[سَوْفَ يَذْهَبُ إِلَى الْمَطْعَمِ اللَّيْلَةَ.]</div>`}
];
const AK_G6=[
{id:'ak-c6-g1',type:'intro',title:'Grammar Overview',body:`<p>In this lesson, we will discuss adverbs.</p>`},
{id:'ak-c6-g2',type:'note',title:'Adverbs',body:`<p>Adverbs tell us how, when, why, how often, or to what degree something happens. They can modify a verb; a word such as “very” can also modify an adjective.</p><p>Many of the adverbs below use <strong>fatḥatan</strong>, the double fatḥa [ـً]. In this spelling pattern, an extra [ا] usually follows the letter bearing fatḥatan. It is not needed after a <em>tāʾ marbūṭa</em> [ة], or after a final hamza already preceded by [ا], as in [مَسَاءً]. Not every Arabic adverb takes fatḥatan—for example, “only” is [فَقَطْ].</p><div class='grammar-pair-grid'><div class='grammar-term'>also <span class='grammar-ar'>أَيْضًا</span></div><div class='grammar-term'>always <span class='grammar-ar'>دَائِمًا</span></div><div class='grammar-term'>sometimes <span class='grammar-ar'>أَحْيَانًا</span></div><div class='grammar-term'>well <span class='grammar-ar'>جَيِّدًا</span></div><div class='grammar-term'>a lot <span class='grammar-ar'>كَثِيرًا</span></div><div class='grammar-term'>a little <span class='grammar-ar'>قَلِيلًا</span></div><div class='grammar-term'>very <span class='grammar-ar'>جِدًّا</span></div><div class='grammar-term'>usually (ending in ة) <span class='grammar-ar'>عَادَةً</span></div></div><div class='grammar-pair-grid'><div class='grammar-term'>in the mornings <span class='grammar-ar'>صَبَاحًا</span><br>The fatḥatan is on [ح]; an extra [ا] follows.</div><div class='grammar-term'>in the late afternoons / evenings <span class='grammar-ar'>مَسَاءً</span><br>The final hamza follows [ا], so no extra alif is added.</div></div><p>Placement can be flexible, but some adverbs naturally follow the verb they describe. For example: “I study well” [أَدْرُسُ جَيِّدًا].</p>`}
];
const AK_CHAPTERS_5_13={5:{subtitle:"Weather, Seasons, and Feelings",vocab:AK_V5,grammar:AK_G5,sentences:AK_S5,learn:["Weather conditions", "Seasons and temperature", "Frequency and degree", "Feelings and circumstances"]},6:{subtitle:"Education, Work, and Hobbies",vocab:AK_V6,grammar:AK_G6,sentences:AK_S6,learn:["Education and graduation", "Work and business", "Adverbs and their spelling", "Time and sequence"]},7:{subtitle:"Life Events and Institutions",vocab:AK_V7,sentences:AK_S7,learn:["Schools and institutions", "Life events", "Government and economics", "Future expressions"]},8:{subtitle:"Government, Study, and the Future",vocab:AK_V8,grammar:AK_G8,sentences:AK_S8,learn:["Government and international affairs", "Study and achievement", "Past-tense conjugation", "Future-tense expressions"]},9:{subtitle:"Daily Routine and Leisure",vocab:AK_V9,sentences:AK_S9,learn:["Daily routines", "Meals and time", "Media and leisure", "Ability and movement"]},10:{subtitle:"Evening Routine, Meetings, and Time",vocab:AK_V10,sentences:AK_S10,learn:["Evening routines", "Meetings and appointments", "Work and time", "Prayer and recreation"]},11:{subtitle:"Travel, Relationships, and Experiences",vocab:AK_V11,sentences:AK_S11,learn:["Travel and tourism", "Relationships and experiences", "Places and geography", "Social interaction"]},12:{subtitle:"Travel, Leave, and Career Decisions",vocab:AK_V12,sentences:AK_S12,learn:["Vacation and holidays", "Career decisions", "Travel and visits", "Scholarships and appointments"]},13:{subtitle:"Ambitions, Work, and the Future",vocab:AK_V13,sentences:AK_S13,learn:["Ambitions and dreams", "Work and opportunities", "Media and writing", "Homesickness and stability"]}};
